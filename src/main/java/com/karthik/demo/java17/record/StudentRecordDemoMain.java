...
public class StudentRecordDemoMain {
    ...
    public static void main(String[] args) {
        ...
        List<StudentRecordDemo> students = Arrays.asList(new StudentRecordDemo("alex", 21, "C"),
                new StudentRecordDemo("benty", 20, "D"),
                new StudentRecordDemo("Karthik", 25, "A")
        );

        //sort the list on grades
        List<StudentRecordDemo> sortedStudentRecords = students.stream().sorted(Comparator.comparing(StudentRecordDemo::grade)).toList();
