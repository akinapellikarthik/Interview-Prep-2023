...
class FindIndexOfSecondHighestNumberTest {
  ...
  FindIndexOfSecondHighestNumber findIndexOfSecondHighestNumber = new FindIndexOfSecondHighestNumber();

  @Test
  void verifySecondHighestIndexFunctionality() {
    Assertions.assertEquals(2, findIndexOfSecondHighestNumber.secondHighestIndex(new int[]{1,4,3}));
  }
  ...
  void verifySecondHighestIndexFunctionality1() {
    Assertions.assertEquals(8, findIndexOfSecondHighestNumber.secondHighestIndex(new int[]{1,4,3,5,8,9,10,55,54}));
  }
}